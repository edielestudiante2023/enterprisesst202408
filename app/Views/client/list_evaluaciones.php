...
<head>
    ...
    <style>
        ...
        .styled-table {
            table-layout: fixed;
            /* Distribuye el ancho de las columnas equitativamente */
            width: 100%;
        }
...
<body class="bg-light">
        ...
        <div>
            <table id="evaluacionesTable" class="styled-table table table-striped">
                <thead>
                    ...
                    <tr>
                        <!-- Filtros de búsqueda para cada columna relevante -->
                        <th></th>
                        <th></th>
                        <th></th>
                        <th></th>
    ...
    <script>
        $(document).ready(function() {
            // Inicializar DataTable con búsqueda global y selectores de filtros
            var table = $('#evaluacionesTable').DataTable({
                initComplete: function() {
                    var api = this.api();

                    // Añadir opciones únicas a cada filtro por columna
                    api.columns([4, 5, 14]).every(function() {
                        var column = this;
